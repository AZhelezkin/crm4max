  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#000', paddingBottom: 80 }}>
      ...
      <div style={{
        ...
        <button
          onClick={() => navigate(-1)}
          style={{ background: 'none', color: '#2688EB', fontSize: 22, lineHeight: 1 }}
        >←</button>
        {master.rating > 0 && (
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          {master.description && (
            <p style={{
              color: '#8E8E93', fontSize: 14, marginTop: 3,
          ...
          {master.location && (
            <p style={{ color: '#8E8E93', fontSize: 13, marginTop: 2 }}>📍 {master.location}</p>
          )}
        </div>
      </div>
            ...
            {master.categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{ color: '#8E8E93', fontSize: 20, flexShrink: 0 }}>›</span>
                </div>
              )
            })}
          </div>
              ...
              <div key={r.id} style={{ background: '#1C1C1E', borderRadius: 14, padding: 14 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                  ...
                  <div>
                    ...
                    <div style={{ color: '#FF9500', fontSize: 13 }}>
