 ...
 * после оплаты сама возвращает пользователя по SuccessURL/FailURL — они
 * указывают на #/pay-result мини-аппа, приложение перезагружается и сразу
 * показывает результат. Авторизация переживает круг: JWT мастера в localStorage.
 *
