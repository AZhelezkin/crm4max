...
export const text = {
  ...
  /** 12 / 14 / 600 UPPERCASE letterSpacing 0.24px (= 2% от 12px) — Figma «Label 2 CAPS», крупный статус-бейдж («% СКИДКИ» в услугах). */
  label2Caps:     {
    fontSize: 12, lineHeight: '14px', fontWeight: 600,
    letterSpacing: 0.24, textTransform: 'uppercase',
  },

  /** 14 / 16 / 500 UPPERCASE letterSpacing 0.42px (= 3% от 14px) — Figma «Caption 3 CAPS», заголовок секции в списке (имя категории «ВОЛОСЫ»). */
  caption3Caps:   {
    fontSize: 14, lineHeight: '16px', fontWeight: 500,
    letterSpacing: 0.42, textTransform: 'uppercase',
  },
