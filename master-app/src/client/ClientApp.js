...
export default function ClientApp() {
    ...
    return (_jsx(HashRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: startParam === 'qr' ? _jsx(QRScanPage, {}) : _jsx(MasterCardPage, {}) }), _jsx(Route, { path: "/qr", element: _jsx(QRScanPage, {}) }), _jsx(Route, { path: "/book/services", element: _jsx(ServiceSelectPage, {}) }), _jsx(Route, { path: "/book/calendar", element: _jsx(CalendarPage, {}) }), _jsx(Route, { path: "/book/confirm", element: _jsx(ConfirmPage, {}) }), _jsx(Route, { path: "/book/deposit", element: _jsx(DepositPage, {}) }), _jsx(Route, { path: "/book/success", element: _jsx(SuccessPage, {}) }), _jsx(Route, { path: "/my-bookings", element: _jsx(MyBookingsPage, {}) }), _jsx(Route, { path: "/my-bookings/:id", element: _jsx(BookingDetailPage, {}) }), _jsx(Route, { path: "/messages", element: _jsx(MessagesPage, {}) }), _jsx(Route, { path: "/contacts", element: _jsx(ContactsPage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/", replace: true }) })] }) }));
}
