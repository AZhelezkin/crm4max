                                        ...
                                        width: '100%',
                                                ...
                                                objectFit: 'cover', flexShrink: 0,
                                                        ...
                                                        justifyContent: 'space-between', marginTop: 4,
                                                                    ...
                                                                    }, children: [(s.price / 100).toLocaleString('ru-RU'), " \u20BD"] }))] }), _jsxs("span", { style: { color: 'var(--color-text-secondary)', fontSize: 13 }, children: [s.durationMin, s.durationMax ? `–${s.durationMax}` : '', " \u043C\u0438\u043D"] })] })] }), _jsx("svg", { width: "9", height: "16", viewBox: "0 0 9 16", fill: "none", style: { flexShrink: 0 }, children: _jsx("path", { d: "M1 1l7 7-7 7", stroke: "#7D7D7F", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }) })] }, s.id));
                            }) })] }, cat.id))) })] }));
}
