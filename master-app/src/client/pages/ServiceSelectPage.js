                                    ...
                                    return (_jsxs("button", { onClick: () => handleSelect(s), style: {
                                            ...
                                            display: 'block',
                                                    ...
                                                    display: 'flex', alignItems: 'center',
                                                            ...
                                                            flex: 1, fontWeight: 600, fontSize: 15, color: '#D3D4D6',
                                                            lineHeight: '20px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                                                        }, children: s.name }), _jsx("svg", { width: "18", height: "18", viewBox: "0 0 18 18", fill: "none", style: { flexShrink: 0, marginLeft: 8 }, children: _jsx("path", { d: "M7 5L11 9L7 13", stroke: "#7D7D7F", strokeWidth: "1.75", strokeLinecap: "round", strokeLinejoin: "round" }) })] }), _jsx("div", { style: {
