  ...
  return (
    <div style={{ minHeight: '100dvh', background: 'var(--color-bg)', paddingBottom: 95 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px 8px' }}>
        <button onClick={() => setViewMonth((m) => m.subtract(1, 'month'))} style={{ background: 'none', padding: '4px 8px' }}>
          <svg width="9" height="16" viewBox="0 0 9 16" fill="none">
            <path d="M8 1L1 8l7 7" stroke="#007AFE" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        <span style={{ fontWeight: 600, color: 'var(--color-text-secondary)', fontSize: 15, textTransform: 'capitalize' }}>
          {viewMonth.format('MMMM YYYY')}
        </span>
        <button onClick={() => setViewMonth((m) => m.add(1, 'month'))} style={{ background: 'none', padding: '4px 8px' }}>
          <svg width="9" height="16" viewBox="0 0 9 16" fill="none">
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {displayedBookings.map((b, idx) => {
              ...
              return (
                ...
                >
                  <div style={{ minWidth: 50, flexShrink: 0, color: 'var(--color-text-secondary)' }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 15, fontWeight: 400, color: 'var(--color-text-secondary)', marginTop: 2 }}>
                      {b.master.name}
                    </div>
                  </div>
                </button>
