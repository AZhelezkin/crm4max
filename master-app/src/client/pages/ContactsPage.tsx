        ...
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
          {master.phone && (
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 15, fontWeight: 500, color: '#D3D4D6' }}>Телефон</div>
                <div style={{ fontSize: 13, color: '#7D7D7F', marginTop: 2 }}>{master.phone}</div>
              </div>
            </button>
          )}
          ...
          {master.lat && master.lng && (
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 15, fontWeight: 500, color: '#D3D4D6' }}>Адрес</div>
                {master.location && (
                  <div style={{ fontSize: 13, color: '#7D7D7F', marginTop: 2 }}>{master.location}</div>
                )}
              </div>
            </button>
          )}
