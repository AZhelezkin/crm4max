        ...
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 10 }}>
          {master.phone && (
            ...
            >
              ...
              <div>
                <div style={{ ...text.bodyMedium, color: 'var(--color-on-surface)' }}>Телефон</div>
                <div style={{ ...text.footnote, color: 'var(--color-on-surface-secondary)', marginTop: 2 }}>{master.phone}</div>
              </div>
            </button>
          )}
          ...
          {master.lat && master.lng && (
            ...
            >
              ...
              <div>
                <div style={{ ...text.bodyMedium, color: 'var(--color-on-surface)' }}>Адрес</div>
                {master.location && (
                  <div style={{ ...text.footnote, color: 'var(--color-on-surface-secondary)', marginTop: 2 }}>{master.location}</div>
                )}
              </div>
            </button>
          )}
