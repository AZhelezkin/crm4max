...
export default function AddressSuggestInput({ value, onChange, confirmedAddress = '' }) {
    ...
    const handleSelect = (s) => {
        ...
        if (centerFromSuggest)
            setMapCenter(centerFromSuggest);
    ...
    return (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', minHeight: 0, height: '100%', position: 'relative', overflow: 'hidden' }, children: [_jsx("img", { src: activeMapUrl, alt: "\u041A\u0430\u0440\u0442\u0430", style: {
                    ...
                    flexShrink: 0,
                        ...
                        backdropFilter: 'blur(6px)',
                                ...
                                onChange(next);
                            }, placeholder: "\u0410\u0434\u0440\u0435\u0441", style: stepOneAddressInputStyle })] }) }), _jsxs("div", { style: { position: 'relative', zIndex: 1, flex: 1, overflowY: 'auto', minHeight: 0 }, children: [suggestions.map((s, i) => (_jsxs("button", { onMouseDown: (e) => { e.preventDefault(); handleSelect(s); }, onClick: () => handleSelect(s), style: {
...
function LocationIcon() {
    return (_jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", style: { flexShrink: 0 }, children: _jsx("path", { d: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z", fill: "var(--color-text-secondary)" }) }));
}
