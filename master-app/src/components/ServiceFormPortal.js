...
export default function ServiceFormPortal({ visible, isEdit, name, onNameChange, desc, onDescChange, duration, onDurationChange, price, onPriceChange, discountEnabled, onDiscountEnabledChange, discountPercent, onDiscountPercentChange, workPhotos, onWorkPhotosChange, categories, categoryId, onCategoryIdChange, onClose, onSave, }) {
